...
call <SID>X("Comment","604060","","none")
call <SID>X("Conditional","e2e4e5","","none")
call <SID>X("Constant","9060c8","","none")
...
call <SID>X("DiffAdd","5060c0","000055","none")
call <SID>X("DiffChange","5060c0","220044","none")
call <SID>X("DiffDelete","604060","302030","none")
call <SID>X("DiffText","7060c0","","none")
call <SID>X("Directory","bebebe","","none")
...
call <SID>X("FoldColumn","bebebe","554455","none")
call <SID>X("Folded","bebebe","554455","none")
call <SID>X("Function","5060c0","","none")
call <SID>X("Identifier","686888","","none")
call <SID>X("Ignore","ff0000","","none")
call <SID>X("IncSearch","e2e4e5","","none")
call <SID>X("Include","e2e4e5","","none")
call <SID>X("Keyword","5060c0","","none")
call <SID>X("Label","805070","","none")
call <SID>X("LineNr","a9a9a9","","none")
...
call <SID>X("MoreMsg","ffffff","","none")
call <SID>X("NonText","a9a9a9","","none")
call <SID>X("Normal","5060c0","000022","none")
call <SID>X("Number","7060c0","","none")
call <SID>X("Operator","8080c0","","none")
call <SID>X("PMenu","d3d3d3","545658","none")
call <SID>X("PMenuSbar","d3d3d3","848688","none")
call <SID>X("PMenuSel","88dd88","949698","none")
call <SID>X("PMenuThumb","d3d3d3","a9a9a9","none")
call <SID>X("PreCondit","e2e4e5","","none")
call <SID>X("PreProc","5060c0","","none")
call <SID>X("Question","ffffff","","none")
call <SID>X("Repeat","e2e4e5","","none")
call <SID>X("Search","000000","998844","none")
call <SID>X("SignColumn","e2e4e5","","none")
call <SID>X("Special","807087","","none")
call <SID>X("SpecialChar","e2e4e5","","none")
call <SID>X("SpecialComment","e2e4e5","","none")
call <SID>X("SpecialKey","ffffff","","none")
...
call <SID>X("Statement","8070b0","","none")
call <SID>X("StatusLine","5060c0","","none")
call <SID>X("StatusLineNC","5060c0","","none")
call <SID>X("StorageClass","e2e4e5","","none")
call <SID>X("String","999999","","none")
...
call <SID>X("Title","bebebe","","none")
call <SID>X("Todo","000000","","none")
call <SID>X("Type","9060c8","","none")
...
call <SID>X("Visual","bebebe","","none")
call <SID>X("VisualNOS","e2e4e5","","underline")
call <SID>X("WarningMsg","000000","","none")
call <SID>X("WildMenu","000000","ffff00","none")
call <SID>X("pythonBuiltin","5060c0","","none")
